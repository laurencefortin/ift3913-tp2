...
/*        list.clear();
    ...
    //   list.clear();
        ...
        System.out.println("Mediane du quartile inf�rieur:" + dataset.getQ1Value(0, 0));
        System.out.println("Mediane du quartile sup�rieur:" +dataset.getQ3Value(0, 0));
    ...
    public static void main(final String[] args) throws IOException {
        ...
        final BoxAndWhiskerDemo donn�esBoiteMoustache = new BoxAndWhiskerDemo("Bo�tes � moustaches", liste);
        donn�esBoiteMoustache.pack();
        RefineryUtilities.centerFrameOnScreen(donn�esBoiteMoustache);
        donn�esBoiteMoustache.setVisible(true);
